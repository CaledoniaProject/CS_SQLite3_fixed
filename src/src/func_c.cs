    ...
    */
    ...
    )
    {
      ...
      if ( p0type != SQLITE_BLOB )
      {
        ...
        //  SQLITE_SKIP_UTF8( ref z2 );
        //}
        sqlite3_result_text( context, z.Length == 0 || p1 > z.Length ? "" : z.Substring( (int)p1, (int)p2 ), (int)p2, SQLITE_TRANSIENT );
      }
      else
      {
        ...
        {
          for ( var i = p1 ; i < p1 + p2 ; i++ ) { sb.Append( (char)zBLOB[i] ); }
        }
    ...
    */
    ...
    )
    {
      ...
      if ( p != null )
      {
        ...
        sqlite3_result_blob( context, new string( p ), (int) n,  null);//sqlite3_free );
      }
    }

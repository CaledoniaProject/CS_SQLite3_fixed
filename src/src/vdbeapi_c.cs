...
sqlite3_mutex mutex = ( (Vdbe)pStmt ).db.mutex;
    ...
    */
    ...
    public static long sqlite3_value_int( sqlite3_value pVal )
    {
...
__attribute__((aligned(8)))
    ...
    */
    ...
    public static long sqlite3_column_int( sqlite3_stmt pStmt, int i )
    {
      long val = sqlite3_value_int( columnMem( pStmt, i ) );
      columnMallocFailure( pStmt );
      return val;
    }
